...
export default function HowPage() {
  return (
    <main className="mx-auto w-full max-w-7xl flex-1 px-4 py-6 md:px-6">
      <p className="kicker text-[color:var(--signal)]">Walkthrough</p>
      <h1
      ...
      <section className="mt-10" data-testid="how-pin">
        <p className="kicker text-[color:var(--signal)]">For the marina</p>
      ...
      <section className="mt-12" data-testid="how-run">
        <p className="kicker text-[color:var(--signal)]">For the boat</p>
      ...
      <section className="mt-12" data-testid="how-storm">
        <p className="kicker text-[color:var(--signal)]">Before they name it</p>
