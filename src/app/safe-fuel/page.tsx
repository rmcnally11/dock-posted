  ...
  return (
    <main className="mx-auto w-full max-w-2xl flex-1 px-4 py-10">
      ...
      <section className="mt-8 space-y-3">
        <h2 className="font-serif text-2xl text-harbor">The hose that damages an outboard</h2>
      ...
      <section className="mt-8 space-y-3">
        <h2 className="font-serif text-2xl text-harbor">E10 runs. E0 sits better.</h2>
        <p className="text-sm leading-7 text-harbor/80">
      ...
      <section className="mt-8 space-y-3">
        ...
        <ul className="list-disc space-y-2 pl-5 text-sm leading-7 text-harbor/80">
          ...
          <li>If the card says Call, No report, or Never — call the dock.</li>
