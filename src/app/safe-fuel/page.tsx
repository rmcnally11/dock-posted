...
export default function SafeFuelPage() {
  return (
    <main className="mx-auto w-full max-w-7xl flex-1 px-4 py-6 md:px-6">
      ...
      <section className="mt-8 max-w-2xl space-y-3">
        <h2 className="font-heading text-2xl text-[color:var(--navy)]">E10 runs. E0 sits better.</h2>
        <p className="text-sm leading-7 text-[color:var(--ink)]/80">
      ...
      <section className="mt-10 max-w-2xl rounded-2xl border border-[color:var(--line)] bg-[color:var(--fog)] p-5 text-sm leading-6 text-[color:var(--ink)]/70">
        <h2 className="font-heading text-xl text-[color:var(--navy)]">Pages we opened</h2>
