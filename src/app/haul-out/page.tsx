...
export const metadata: Metadata = {
  title: "Yard seats",
  description:
    "When they name a storm, yards fill up. Who still has a seat. You call the yard. We don’t pull her.",
};
  ...
  return (
    <main className="mx-auto w-full max-w-7xl min-w-0 flex-1 overflow-x-hidden px-4 py-4 md:px-6 lg:py-6">
      ...
      <p className="mt-3 max-w-2xl text-sm leading-6 text-[color:var(--ink)]/60">
        ...
        tell you what’s left at the two yards you already picked. We are not the yard. We
        do not haul, store, or insure. We don’t invent a hole. You call the yard. We
        don’t pull her. Wet slips stay Coastal Cavaliers — not this product.
      </p>
      ...
      <HowItWorks
        ...
        intro="One page on file. A note when they name it. You make the call."
        steps={STORM_WALK}
      />
      ...
      <section id="yard-board" className="mt-8 max-w-3xl lg:mt-12">
        <h2 className="font-heading text-2xl text-[color:var(--navy)]">Who still has a seat</h2>
        <p className="mt-2 text-sm leading-6 text-[color:var(--ink)]/70">
          If you won’t say the number, the boats don’t come. A leftover seat stays blank
        ...
        {emptyBoard ? (
          <p data-testid="leftover-empty" className="mt-3 text-sm text-[color:var(--ink)]/55">
            No yard has said what’s left.
          </p>
        ) : null}
        {params.posted ? (
          <p className="mt-3 rounded-md bg-fresh/10 px-3 py-2 text-sm text-fresh">
            Leftover seats are up. We use what you said.
          </p>
        ) : null}
      ...
      <section className="mt-12 max-w-3xl border-t border-[color:var(--line)] pt-8 text-xs leading-6 text-[color:var(--ink)]/50">
        <p>
          Owner: {NAMED_STORM_PLAN_PRICE} to file the boat. One page, a primary and
          a backup, plus a note when NHC names a storm in the cone — what’s left, and the
        ...
        <p className="mt-3">
          ...
          won’t say what’s left, it stays blank, and they get no boats.
        </p>
