...
assert.match(deskSource, /From the terminal to what they wrote on the board\./);
assert.match(deskSource, /Come in/);
assert.match(deskSource, /From the terminal to the dock/);
...
assert.match(wholesalePage, /From the terminal to what they wrote on the board\./);
assert.doesNotMatch(wholesalePage, /The take/);
assert.doesNotMatch(wholesalePage, /fat cut lights up/);
assert.match(printPage, /This week.s sheet/);
